...
const API_URL = "http://192.168.43.92/api/analyze-crop";
// !!!                                                     !!!
// --- End Configuration ---

export default function HomeScreen() {
  // Use 'HomeScreen' or 'App' depending on your file name
  ...
  const pickImage = async () => {
    ...
    if (status !== "granted") {
      Alert.alert(
        "Permission required",
        "Need access to your photos to pick an image."
      );
      return;
    }
      ...
      {result && (
        <View style={styles.resultBox}>
          ...
          <Text
            style={[
              styles.resultText,
              { marginTop: 10, fontWeight: "bold", color: "red" },
            ]}
          >
